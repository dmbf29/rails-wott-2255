class CreateChallengeTool < RubyLLM::Tool
  ...
  description "Use this tool when the user asks to create a challenge. After creation, provide a link to that challenge. Include the link as markdown URL: /challenges/:challenge_id"
  ...
  param :instructions, desc: <<~TXT
    ...
    You should create a custom challenge based on the user's request in Markdown. It should be broken into multiple sections: Background & Objectives, Spec, and Further Learning.
